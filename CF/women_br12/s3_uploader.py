...
from CF.config import (
    ...
    CF_R2_ENDPOINT_URL, CF_R2_REGION, S3_IMAGES_PATH, TEMP_DIR
)
...
class S3Uploader:
    ...
    def __init__(self):
        self.s3_client = boto3.client(
            's3',
            endpoint_url=CF_R2_ENDPOINT_URL,          # R2 custom endpoint
            aws_access_key_id=CF_R2_ACCESS_KEY_ID,
            aws_secret_access_key=CF_R2_SECRET_ACCESS_KEY,
            region_name=CF_R2_REGION,                  # dummy value, R2 ignores it
            config=Config(
                signature_version='s3v4',              # explicit sig version required
